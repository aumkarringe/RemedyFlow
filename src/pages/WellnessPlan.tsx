    ...
    try {
      const { data, error } = await supabase.functions.invoke('ai-chat', {
        body: {
          ...
          systemPrompt: "You are a holistic wellness coach. Create comprehensive, achievable wellness plans. Always respond with valid JSON array."
        }
      });
      ...
      if (jsonMatch) {
        ...
        setAiRemedies(plan.map((item: any) => ({ ...item, source: "AI-Generated" })));
      }
    } catch (error) {
        ...
        >
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Generate a custom wellness plan tailored to your health goals
            </p>
          </div>
        </motion.div>
